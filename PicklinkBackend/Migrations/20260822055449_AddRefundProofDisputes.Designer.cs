...
namespace Picklink_API.Migrations
{
    ...
    [Migration("20260822055449_AddRefundProofDisputes")]
    partial class AddRefundProofDisputes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PicklinkBackend.Models.MatchCheckIn", b =>
                {
                    ...
                    b.HasIndex("BookingCheckInGroupId");
                    ...
                    b.HasIndex(new[] { "MatchId", "PlayerId", "BookingCheckInGroupId" }, "UQ_MATCH_CHECKIN_UNIQUE")
                        .IsUnique()
                        .HasFilter("[bookingCheckInGroupId] IS NOT NULL");
            ...
            modelBuilder.Entity("PicklinkBackend.Models.OwnerBankAccount", b =>
                {
                    ...
                    b.Property<string>("SePayApiToken")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("sePayApiToken");
            ...
            modelBuilder.Entity("PicklinkBackend.Models.Payment", b =>
                {
                    ...
                    b.Property<bool>("AllowPaymentByOthers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("allowPaymentByOthers");
                    ...
                    b.Property<DateTime?>("ClaimExpiresAt")
                        .HasColumnType("datetime")
                        .HasColumnName("claimExpiresAt");

                    b.Property<int?>("ClaimedByPlayerId")
                        .HasColumnType("int")
                        .HasColumnName("claimedByPlayerId");
                    ...
                    b.Property<string>("RefundDisputeReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("refundDisputeReason");

                    b.Property<string>("RefundDisputeResolution")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("refundDisputeResolution");

                    b.Property<DateTime?>("RefundDisputeResolvedAt")
                        .HasColumnType("datetime")
                        .HasColumnName("refundDisputeResolvedAt");

                    b.Property<int?>("RefundDisputeResolvedByUserId")
                        .HasColumnType("int")
                        .HasColumnName("refundDisputeResolvedByUserId");

                    b.Property<string>("RefundDisputeStatus")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasColumnName("refundDisputeStatus");

                    b.Property<DateTime?>("RefundDisputedAt")
                        .HasColumnType("datetime")
                        .HasColumnName("refundDisputedAt");

                    b.Property<string>("RefundProofImageUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasColumnName("refundProofImageUrl");

                    b.Property<DateTime?>("RefundProofSubmittedAt")
                        .HasColumnType("datetime")
                        .HasColumnName("refundProofSubmittedAt");
            ...
            modelBuilder.Entity("PicklinkBackend.Models.User", b =>
                {
                    ...
                    b.Property<int?>("UnlockedByUserId")
                        .HasColumnType("int")
                        .HasColumnName("unlockedByUserId");
            ...
            modelBuilder.Entity("PicklinkBackend.Models.User", b =>
                {
                    b.HasOne("PicklinkBackend.Models.User", "LockedByUser")
                        .WithMany()
                        .HasForeignKey("LockedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_USER_LOCKED_BY");

                    b.HasOne("PicklinkBackend.Models.User", "UnlockedByUser")
                        .WithMany()

...
public partial class CommunityService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await _communityRepository.AddGroupAsync(group, cancellationToken);
        await _communityRepository.AddMemberAsync(new GroupMember
        {
            Group = group,
            UserId = userId.Value,
            Role = OwnerRole,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (member is null)
        {
            ...
            await _communityRepository.AddMemberAsync(member, cancellationToken);
        }

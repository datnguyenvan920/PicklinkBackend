...
namespace PicklinkBackend.Services.Venues.Implementations;

public sealed class VenueNearbyQueryService
{
    private readonly IVenueRepository _venueRepository;

    public VenueNearbyQueryService(IVenueRepository venueRepository)
    {
    ...
    {
        var venuesWithCoords = await _venueRepository.Venues
